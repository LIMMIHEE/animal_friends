	...
	public void dropNote(String titleName) {
		...
		if(titleName.equals("Tutorial") && difficult.equals("nano")) {
			...
			beats = new Beat[] {
					...
					new Beat(startTime + gap* 6,"RIGHT"),
					new Beat(startTime + gap* 8,"UP"),
					new Beat(startTime + gap* 10,"LEFT"),
					new Beat(startTime + gap* 12,"LEFT"),
					new Beat(startTime + (gap)* 14,"LEFT"),
					new Beat(startTime + (gap)* 16,"UP"),
					new Beat(startTime + (gap-50)* 20,"RIGHT"),
					new Beat(startTime + (gap-50)* 22,"UP"),
					new Beat(startTime + (gap-50)* 24,"RIGHT"),
					new Beat(startTime + (gap-50)* 26,"UP"),
					new Beat(startTime + (gap-50)* 28,"LEFT"),
					new Beat(startTime + (gap-40)* 30,"UP"),
					new Beat(startTime + (gap-40)* 32,"LEFT"),
					new Beat(startTime + (gap-40)* 34,"UP"),
					new Beat(startTime + (gap-40)* 36,"LEFT"),
					new Beat(startTime + (gap-30)* 38,"RIGHT"),
					new Beat(startTime + (gap-30)* 40,"UP"),
					new Beat(startTime + (gap-30)* 60,"LEFT"),
					new Beat(startTime + (gap-30)* 63,"LEFT"),
					new Beat(startTime + (gap-50)* 67,"UP"),
					new Beat(startTime + (gap-50)* 70,"LEFT"),
					new Beat(startTime + (gap-30)* 73,"LEFT"),
					new Beat(startTime + (gap-30)* 75,"UP"),
					new Beat(startTime + (gap-30)* 77,"RIGHT"),
					new Beat(startTime + (gap-30)* 79,"LEFT"),
					new Beat(startTime + (gap-50)* 82,"RIGHT"),
					new Beat(startTime + (gap-50)* 85,"LEFT"),
					new Beat(startTime + (gap-50)* 89,"RIGHT"),
					new Beat(startTime + (gap-50)* 91,"LEFT"),
					new Beat(startTime + (gap-50)* 94,"RIGHT"),
					new Beat(startTime + (gap-50)* 97,"UP"),
					new Beat(startTime + (gap-50)* 100,"LEFT"),
					new Beat(startTime + (gap-50)* 103,"LEFT"),
					new Beat(startTime + (gap-50)* 106,"LEFT"),
					new Beat(startTime + (gap-50)* 109,"UP"),
					new Beat(startTime + (gap-50)* 111,"RIGHT"),
					new Beat(startTime + (gap-50)* 114,"LEFT"),
					new Beat(startTime + (gap-50)* 117,"UP"),
					new Beat(startTime + (gap-50)* 120,"LEFT"),
					new Beat(startTime + (gap-50)* 123,"RIGHT"),
					new Beat(startTime + (gap-50)* 127,"UP"),
